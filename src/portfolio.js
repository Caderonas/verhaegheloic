  ...
  render(){
      return (
          <div className="portfolio">
              ...
              <ul>
                  <li>
                      <img alt="Blason de la ville de Mouscron" src="http://lamouscronnoise.be/Shared/images/logo_msc.svg"/>
                      <h4>La Mouscronnoise</h4>
                  ...
                  <li>
                      <h4><a href="http://lamouscronnoise.be/Mouscron_Eurometropolitan_city/index.html" target="_blank" rel="noreferrer">Eurometropolitan</a></h4>
                      <p>This website was asked by a friends who has to present his final study work as architect remotly.</p>
